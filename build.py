...
def post_docs(project, logger):
    ...
    result = call(['curl', '-X', 'POST', 'http://readthedocs.org/build/enplicaw'])
    logger.info("Commit hook @ http://readthedocs.org/build/enplicaw: %d" % result)
